 ...
 *   HTTP/1.1 412 Precondition Failed
 */
app.patch('/api/v1/users/:userId/parcels/:parcelId', authController.verifyToken, (req, res) => {
  parcelController.activateParcel(req, res);
});
 ...
 *   HTTP/1.1 412 Precondition Failed
 */
app.get('/api/v1/users/:userId/parcels/:parcelId', authController.verifyToken, (req, res) => {
  parcelController.getParcelBySpecificUser(req, res);
});
